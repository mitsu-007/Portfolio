...
export const certificatesData: CertificateItem[] = [
  {
    ...
    image: 'https://res.cloudinary.com/dkduejkuj/image/upload/v1788356408/5a8d8cff-edf8-4765-b1c6-3a72ef400b2c.png',
  ...
  },
  {
    ...
    recipient: 'Nidhi Kumari',
    image: 'https://res.cloudinary.com/dkduejkuj/image/upload/v1788354297/DataScienceEssentialswithPythonv120260831-20-pan745_page-0001_bt3kq8.jpg',
    description: 'Achieved course completion credential for Data Science Essentials with Python from Cisco Networking Academy, demonstrating proficiency in data analysis, visualization, statistical modeling, and data-driven problem solving.',
    topics: [
      'Python for Data Analysis & Analytics',
      'Data Cleaning, Preprocessing & Transformation',
      'Exploratory Data Analysis (EDA)',
      'Data Visualization with Matplotlib & Seaborn',
      'Statistical Foundations & Predictive Concepts'
    ],
    verificationUrl: '#',
  },
  {
    ...
    recipient: 'Nidhi Kumari',
    image: 'https://res.cloudinary.com/dkduejkuj/image/upload/v1788354434/OperatingSystemsBasicsUpdate20260827-20-79m16t_page-0001_fm08tw.jpg',
    description: 'Achieved student level credential for completing the Operating System Basics course from Cisco Networking Academy, demonstrating core knowledge of operating system architectures, process management, filesystem operations, and system security.',
    topics: [
      'Operating System Architecture & Core Functions',
      'Process & Memory Management Principles',
      'File Systems & Storage Management',
      'User Management & Access Control Security',
      'Basic Command Line Operations & Utilities'
    ],
    verificationUrl: 'https://res.cloudinary.com/dkduejkuj/image/upload/v1788354413/2677d205-6957-44cf-9737-293bf4ea582f_dnqilp.jpg',
  },
  {
    id: 'gfg-career-boost',
